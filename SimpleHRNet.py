...
from AI.tripling_detection.models.hrnet import HRNet
from AI.tripling_detection.models.poseresnet import PoseResNet
from AI.tripling_detection.models.detectors.YOLOv3 import YOLOv3  # import only when multi-person is enabled
...
class SimpleHRNet:
    ...
    def __init__(self,
        ...
        if self.multiperson:
            from AI.tripling_detection.models.detectors.YOLOv3 import YOLOv3
